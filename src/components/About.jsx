...
import { Briefcase, Code, Sparkles, CheckCircle2, Trophy, Star } from "lucide-react";
...
function About() {
  ...
  return (
    <div className="bg-[#0a0a0a]">
      <section id="about" className="py-14 sm:py-16 px-4 md:px-8 max-w-6xl mx-auto">
        {/* Section Heading */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center" data-aos="fade-right">
            <div className="relative group">
              ...
              <div className="absolute -bottom-4 right-1 sm:-right-3 bg-[#151515] border border-gray-800 p-2.5 sm:p-3 rounded-xl shadow-xl flex items-center gap-2.5 backdrop-blur-md">
          ...
          {/* Right Side: Professional Bio & Resume Highlights */}
          <div className="lg:col-span-7 space-y-4" data-aos="fade-left">
            <div className="bg-[#151515] p-5 sm:p-6 rounded-xl border border-gray-800 space-y-3.5 shadow-xl relative overflow-hidden">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-gray-300 font-medium">
                I am <strong className="text-white font-bold">Abhinam Kumar Mahato</strong>, a Computer Science & Engineering undergraduate at <strong className="text-pink-400 font-semibold">R.V.S College of Engineering and Technology</strong>. I specialize in software development, AI/ML computational models, and full-stack web applications.
              </p>

              <p className="text-xs sm:text-sm leading-relaxed text-gray-300 font-medium">
                My industry experience includes working as an <strong className="text-white">SDE Intern at Tata Steel Limited</strong> (building the Samadhan App and modernizing DARPAN enterprise application), a <strong className="text-white">Research Project Intern at CSIR–CIMFR</strong> (developing Python computational models for Underground Coal Gasification using Cantera), and a <strong className="text-white">Front-End Developer Intern at AutoCluster</strong>.
              </p>

              <p className="text-xs sm:text-sm leading-relaxed text-gray-300 font-medium">
                I am proficient in <span className="text-pink-400 font-semibold">C++, Python, JavaScript, React.js, and SQL</span>, with a strong foundation in Data Structures & Algorithms, DBMS, and Machine Learning.
              </p>

              {/* Achievements Key Points */}
